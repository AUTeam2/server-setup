...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('test_module', '0006_auto_20200223_0900'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Inbound_teststand_package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameters', to='test_module.Inbound_teststand_package')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Inbound_teststand_package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='data', to='test_module.Inbound_teststand_package')),
            ],
            options={
