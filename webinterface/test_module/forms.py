"""
This file defines form control elements for the test_module
...
class TestForm(forms.Form):
    ...
    TOPICS = (
        ('Testdevice/test_module/Inbound','Testdevice/test_module/Inbound'),
        ('Testdevice/test_module/Outbound','Testdevice/test_module/Outbound'),
    )
...
class AccelerometerForm(forms.Form):
    """
    Denne klasse implementerer formularen til GUI-test, som vises på Webinterface
    """
    SENSOR_TYPES = (
        ('adxl345', 'adxl345'),
        ('Kx224', 'Kx224'),
