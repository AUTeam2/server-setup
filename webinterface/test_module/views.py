"""
Contains view functions for the test_module
URL paths that lead here are in test_module/urls.py
"""
...
def gui_test(request):
    """
    This view generates contents for a test page, to show GUI possibilities.
    ...
    return render(request, 'test_module/gui-test.html', {'script': script, 'div': div, 'form': form})


# Show landing page for the test module
def test_main_page(request):
    return render(request, 'test_module/home.html')


# Show test creation form for the test module
def test_create_test(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            template = loader.get_template('test_module/message_sent.html')
    ...
    return render(request, 'test_module/make_test.html', {'form': form})
...
def transmit_mqtt(form_obj):
    ...
    # Create client
    publisher = MqttClient("testModuleMessageSender", donothing)
...
def test_running_test(request):
    #Not done
    return render(request, 'test_module/running_test.html')
...
def show_data(request, test_id):
    ...
    template_name = 'test_module/show_data.html'
...
#Info page about the test module
...
def test_busy(request):
    return render(request, 'test_module/busy.html')
...
def test_stream(request):
    ...
    return render(request, 'test_module/streaming-test.html', context)
